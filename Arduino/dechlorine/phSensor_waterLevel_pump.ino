...
int        port     = 1883;
const char topic_ph[]  = "dechlorine/ph";
const char topic_level[] = "dechlorine/level";
const char topic_pump[] = "dechlorine/pump";
int samples = 10;
...
void setup() {
  ...
  mqttClient.setId("arduino-client-dechlorine-ph");
